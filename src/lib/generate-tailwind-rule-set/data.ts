export const CONSTANTS = {
    ...
    ALIGN_CONTENT: 'normal|center|start|end|between|around|evenly|baseline|stretch',
    FONT_AND_SHADOW_SIZE: 'xs|sm|base|md|lg|xl|2xl|3xl|4xl|5xl|6xl|7xl|8xl|9xl|inner|none',
